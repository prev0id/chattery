...
// 	CreateMessage(ctx context.Context, message *domain.TopicMessage) (domain.MessageID, error)
// 	FirstPageOfMessages(ctx context.Context, chat domain.ChatID) ([]*domain.TopicMessage, *domain.MessageCursor, error)
// 	NextPageOfMessages(ctx context.Context, chat domain.ChatID, cursor *domain.MessageCursor) ([]*domain.TopicMessage, *domain.MessageCursor, error)
// }

// type pubsub interface {
// 	SendMessage(ctx context.Context, chat domain.ChatID, message domain.TopicMessage) error
// 	Subscribe(ctx context.Context, chat domain.ChatID, dst chan<- *domain.TopicMessage)
// }
